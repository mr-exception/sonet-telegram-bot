...
db.serialize(function () {
    var query = fs.readFileSync("./init.sql").toString().split("\n");
    query.forEach(function (q) { return db.run(q); });
    console.debug("database initialized...");
});
bot.onText(/\/new/, newCommand.handleInit);
bot.on("message", function (msg) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, newCommand.handleGetAmount(msg)];
            case 1:
                if (_a.sent()) {
                    return [2 /*return*/];
                }
...
bot.on("callback_query", function (msg) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, newCommand.handleGetDsts(msg)];
            case 1:
                if (_a.sent()) {
                    return [2 /*return*/];
                }
